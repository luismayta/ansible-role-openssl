...
To contribute to ansible-role-openssl project on [GitHub](https://github.com/hadenlabs/ansible-role-openssl), We use Gitflow (See more [here](https://datasift.github.io/gitflow/IntroducingGitFlow.html)) In a nutshell, it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/hadenlabs/ansible-role-openssl/pulls).

![workflow gitflow](https://datasift.github.io/gitflow/GitFlowHotfixBranch.png)

## Getting started

To follow the instructions in this guide and start contributing to ansible-role-openssl project on Gitlab:
...
```bash
git remote add upstream  https://github.com/hadenlabs/ansible-role-openssl.git
```

Now your **upstream** points to **hadenlabs/ansible-role-openssl**.
...
git fetch upstream # assuming upstream is hadenlabs/ansible-role-openssl
...
All merge requests are automatically tested using [Github Actions](https://github.com/hadenlabs/ansible-role-openssl/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
